    ...
    <div className="">
      <div className="flex flex-col md:flex-row md:space-x-[50px] justify-center items-center">
        <div className="md:mr-[40px]">
          <div className="h-[350px] w-[280px] md:h-[500px] md:w-[400px] bg-red rounded-2xl"></div>
          <div className="h-[350px] w-[280px] md:h-[500px] md:w-[400px] rounded-2xl overflow-hidden shadow-2xl z-3 mt-[-325px] md:mt-[-475px] ml-[18px] md:ml-[25px]">
            <img
        ...
        <div className="flex flex-col justify-center mt-8 md:mt-0">
          ...
          <span className="text-xl md:text-2xl md:mt-[40px] mt-[20px]">
          ...
          <span className="mt-[10px] text-base md:text-lg">
            Andi Alif Badawi Harist
          </span>
          <span className="mt-[-5px] text-base md:text-lg">Class of 2027</span>
        </div>
      </div>
    </div>
  );
