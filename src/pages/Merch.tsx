  ...
  return (
    <div className="mb-[120px]">
      <div className="w-full h-[600px] flex justify-center items-end">
        <img src={process.env.PUBLIC_URL + "/merch/background.png"} alt="Background" className="object-cover w-full h-full" />
      </div>
      <div className="flex items-center justify-center text-6xl font-semibold mt-10">Merch</div>
        ...
        <div className="flex">
          <button onClick={openPopup}>
            <div className="h-[660px] w-[450px] mr-[200px] bg-white rounded-2xl shadow-2xl flex flex-col justify-center items-center">
              <img src={process.env.PUBLIC_URL + "/merch/2021_Hoodie_Main.png"} alt="2021 hoodie" width={450} />
