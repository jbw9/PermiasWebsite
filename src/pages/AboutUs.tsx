  ...
  return (
    <div className="">
      <div className="w-full h-[600px] flex justify-center items-end mb-[100px]">
        <img src={process.env.PUBLIC_URL + "/AboutUs/background.png"} alt="Background" className="object-cover w-full h-full" />
      </div>
      <div className="container px-4 mx-auto">
        <div className="md:h-full md:flex flex flex-col md:flex-row md:items-center">
          ...
          <div className="flex justify-center md:w-1/2 md:justify-end w-full">
            <img className="shadow-2xl rounded-xl" src={process.env.PUBLIC_URL + "/AboutUs/image1.png"} alt="PERMIAS LOGO" height={400} width={550} />
          </div>
        </div>
      </div>

      <div className="container px-4 pt-32 mx-auto">
        <div className="md:h-full md:flex flex flex-col-reverse md:flex-row md:items-center">
          <div className="md:w-1/2">
            <img className="shadow-2xl rounded-xl" src={process.env.PUBLIC_URL + "/AboutUs/image2.png"} alt="PERMIAS LOGO" height={400} width={550} />
          </div>
          <div className="flex flex-col justify-center md:w-1/2">
      ...
      <div className="container px-4 py-32 mx-auto">
        <div className="md:flex md:h-full flex flex-col md:flex-row md:items-center">
          <div className="flex flex-col justify-center md:w-1/2">
          ...
          <div className="flex justify-center md:w-1/2 md:justify-end">
            <img className="shadow-2xl rounded-xl" src={process.env.PUBLIC_URL + "/AboutUs/image3.png"} alt="PERMIAS LOGO" height={400} width={550} />
          </div>
        </div>
      </div>
    </div>
